...
var canvasElements = [];
var canvas1 = document.getElementById("simCanvas1");
canvasElements.push(canvas1);
var canvas2 = document.getElementById("simCanvas2");
canvasElements.push(canvas2);
var Sim = new simulation_1.Simulation(canvasElements);
...
var Simulation = (function () {
    function Simulation(canvasElements) {
        this._canvasElements = [];
        this._objects = [];
        for (var i = 0, len = canvasElements.length; i < len; i++) {
